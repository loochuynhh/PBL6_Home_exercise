...
const Chatbot = () => {
  ...
  const suggestedQuestions = [
    ...
    "Can you recommend stretches for recovery?"
  ];
  ...
  const sendMessage = async (message) => {
    ...
    try {
      const botReponse = "You are a professional gym assistant chatbot. Please provide concise and professional answers. The user's question is: ";
